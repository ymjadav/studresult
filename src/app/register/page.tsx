  ...
  return (
    <>
      ...
      <section className="bg-gray-900">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto h-lvh lg:py-0">
          <div className="w-full bg-gray-300 rounded-lg shadow-lg dark:border md:mt-0 sm:max-w-md xl:p-0">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 className="text-xl font-bold leading-tight tracking-tight text-center md:text-2xl text-black">
                Create an account
              </h1>
              <form className="space-y-4 md:space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="terms" className="font-sm text-black">
                      I accept the{" "}
                      <Link
                ...
                <p className="text-sm font-sm  text-black">
